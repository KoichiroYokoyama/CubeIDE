...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, SERIAL0_T_Pin|SERIAL0_R_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(SERIAL2_T_GPIO_Port, SERIAL2_T_Pin);

    HAL_GPIO_DeInit(SERIAL2_R_GPIO_Port, SERIAL2_R_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, SERIAL1_T_Pin|SERIAL1_R_Pin);
